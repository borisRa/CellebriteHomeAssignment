...
def main() :
	...
	#Set aside any chats for which there are no mappings between segments of summaries and their corresponding original chats
	mapped_subset_df_without_mapped_substes = mapped_subset_df[mapped_subset_df.similarity.isnull()].copy()
	mapped_subset_df = mapped_subset_df[~mapped_subset_df.similarity.isnull()].copy()
	...
	#reconstructed_df.to_csv("reconstructed_df_1.csv",index=False)
...
tf_idf = vectorizer.fit(result_df['dialogue'])
